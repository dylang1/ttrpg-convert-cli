...
public enum Pf2VttActivity implements JsonNodeReader {
    ...
    Pf2VttActivity(String longName, String textGlyph, String glyph) {
    ...
    public static Pf2VttActivity toActivity(String unit, int number) {
        switch (unit) {
            case "single":
            case "action":
                switch (number) {

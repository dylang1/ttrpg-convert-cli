...
public interface JsonSource extends JsonTextReplacement {
    ...
    default void appendAbility(List<String> text, JsonNode node) {
        renderEmbeddedTemplate(text,
            Pf2VttTypeAbility.createAbility(node, this, true),
            "ability", List.of());
    }
...
//
//        Map<String, QuteInlineAffliction.QuteAfflictionStage> stages = new LinkedHashMap<>();
...
//
//            QuteInlineAffliction.QuteAfflictionStage stage = new QuteInlineAffliction.QuteAfflictionStage();
...
//        renderInlineTemplate(text, inlineAttack, "attack");
    ...
    default void embedData(List<String> text, JsonNode dataNode) {
        ...
        Pf2VttIndexType dataType = Pf2VttIndexType.fromText(tag);
        ...
        if (data == null) {
            ...
            if (dataType == Pf2VttIndexType.creature) {
            ...
            Pf2VttQuteBase converted = dataType.convertJson2QuteBase(index(), data);
            if (converted != null) {
...
//            String level = Json2QuteItem.Pf2eItem.level.getTextOrNull(data);
    ...
    enum AttackField implements JsonNodeReader {
        ...
        public static QuteInlineAttack createInlineAttack(JsonNode node, JsonSource convert) {
            ...
            QuteDataActivity activity = Pf2VttActivity.single.toQuteActivity(convert, null);

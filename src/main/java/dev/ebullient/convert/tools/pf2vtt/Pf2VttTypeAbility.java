...
import dev.ebullient.convert.tools.pf2vtt.qute.QuteAbility;

public enum Pf2VttTypeAbility implements JsonNodeReader {
    activity,
    components,
    cost,
    creature,
    ...
    public static QuteAbility createAbility(JsonNode node, JsonSource convert, boolean embedded) {
        ...
        try {
            ...
            final String abilitySrc = convert.parseState().getSource(Pf2VttIndexType.ability);
